...
public class FormalConstraintLanguageItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addLibraryLocationPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Library Location feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addLibraryLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FormalConstraintLanguage_libraryLocation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FormalConstraintLanguage_libraryLocation_feature", "_UI_FormalConstraintLanguage_type"),
				 ConstraintsPackage.Literals.FORMAL_CONSTRAINT_LANGUAGE__LIBRARY_LOCATION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConstraintsPackage.Literals.FORMAL_CONSTRAINT_LANGUAGE__OWNED_LIBRARIES);
			childrenFeatures.add(ConstraintsPackage.Literals.FORMAL_CONSTRAINT_LANGUAGE__OWNED_INTERPRETER);
			childrenFeatures.add(ConstraintsPackage.Literals.FORMAL_CONSTRAINT_LANGUAGE__OWNED_PERSISTER);
			childrenFeatures.add(ConstraintsPackage.Literals.FORMAL_CONSTRAINT_LANGUAGE__OWNED_VIEWER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConstraintsPackage.Literals.FORMAL_CONSTRAINT_LANGUAGE__OWNED_LIBRARIES,
				 ConstraintsFactory.eINSTANCE.createFormalLanguageLibrary()));

		newChildDescriptors.add
			(createChildParameter
				(ConstraintsPackage.Literals.FORMAL_CONSTRAINT_LANGUAGE__OWNED_INTERPRETER,
				 ConstraintsFactory.eINSTANCE.createServiceDescriptor()));

		newChildDescriptors.add
			(createChildParameter
				(ConstraintsPackage.Literals.FORMAL_CONSTRAINT_LANGUAGE__OWNED_PERSISTER,
				 ConstraintsFactory.eINSTANCE.createServiceDescriptor()));

		newChildDescriptors.add
			(createChildParameter
				(ConstraintsPackage.Literals.FORMAL_CONSTRAINT_LANGUAGE__OWNED_VIEWER,
				 ConstraintsFactory.eINSTANCE.createServiceDescriptor()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ConstraintsPackage.Literals.FORMAL_CONSTRAINT_LANGUAGE__OWNED_INTERPRETER ||
			childFeature == ConstraintsPackage.Literals.FORMAL_CONSTRAINT_LANGUAGE__OWNED_PERSISTER ||
			childFeature == ConstraintsPackage.Literals.FORMAL_CONSTRAINT_LANGUAGE__OWNED_VIEWER;
