 ...
 *   <li>{@link fr.labsticc.framework.settings.model.settings.PropertyAssociation#getSubclass <em>Subclass</em>}</li>
 * </ul>
 * </p>
 *
...
public interface PropertyAssociation extends IdentifiedElement {
	 ...
	 * @see fr.labsticc.framework.settings.model.settings.SettingsPackage#getPropertyAssociation_Subclass()
	 * @model
	 * @generated
	 */
	EClass getSubclass();
	...
	/**
	 * Sets the value of the '{@link fr.labsticc.framework.settings.model.settings.PropertyAssociation#getSubclass <em>Subclass</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
