 ...
 *   <li>{@link fr.labsticc.framework.settings.model.settings.impl.PropertyAssociationImpl#getSubclass <em>Subclass</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class PropertyAssociationImpl extends IdentifiedElementImpl implements PropertyAssociation {
	...
	public EClass getSubclass() {
		if (subclass != null && subclass.eIsProxy()) {
			...
			if (subclass != oldSubclass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SettingsPackage.PROPERTY_ASSOCIATION__SUBCLASS, oldSubclass, subclass));
			}
		}
		return subclass;
	}
	...
	public void setSubclass(EClass newSubclass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SettingsPackage.PROPERTY_ASSOCIATION__SUBCLASS, oldSubclass, subclass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SettingsPackage.PROPERTY_ASSOCIATION__SUBCLASS:
