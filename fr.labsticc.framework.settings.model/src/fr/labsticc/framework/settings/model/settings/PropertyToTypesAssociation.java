 ...
 *   <li>{@link fr.labsticc.framework.settings.model.settings.PropertyToTypesAssociation#getOwnedCondition <em>Owned Condition</em>}</li>
...
public interface PropertyToTypesAssociation extends IdentifiedElement, PropertyAssociation {
	 ...
	 * @see #setOwnedCondition(FormalLanguageExpression)
	 * @see fr.labsticc.framework.settings.model.settings.SettingsPackage#getPropertyToTypesAssociation_OwnedCondition()
	 * @model containment="true"
	 * @generated
	 */
	FormalLanguageExpression getOwnedCondition();

	/**
	 * Sets the value of the '{@link fr.labsticc.framework.settings.model.settings.PropertyToTypesAssociation#getOwnedCondition <em>Owned Condition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setOwnedCondition(FormalLanguageExpression value);

	/**
	 * Returns the value of the '<em><b>Parent</b></em>' container reference.
	 * It is bidirectional and its opposite is '{@link fr.labsticc.framework.settings.model.settings.ModelingLanguageAssociations#getOwnedPropToTypesAssociations <em>Owned Prop To Types Associations</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @model opposite="ownedPropToTypesAssociations" required="true" transient="false"
	 * @generated
	 */
