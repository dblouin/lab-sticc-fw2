...
public class ConstraintExpressionPanel extends ConstraintPanel {
	...
	public void displayData( final FormalLanguageExpression p_expression ) {
		...
		if ( p_expression == null ) {
			...
			languageId = p_expression == null ? null : p_expression.getLanguage() == null ? null : p_expression.getLanguage().getId();
		...
		displayData( expressionText, null, getActionHandler().libraryNames() );
	}
