...
public class IDEConstraintViewersConfiguration implements IConstraintViewersConfiguration {
	...
	throws ClassNotFoundException, IllegalAccessException, InstantiationException {
		if ( p_language instanceof FormalConstraintLanguage ) {
			...
			final ServiceDescriptor descr = formalLanguage.getOwnedViewer();
...
//			}
			...
			final IConstraintLanguageViewerConfig viewerConfig = (IConstraintLanguageViewerConfig) descr.getServiceClass().newInstance();
