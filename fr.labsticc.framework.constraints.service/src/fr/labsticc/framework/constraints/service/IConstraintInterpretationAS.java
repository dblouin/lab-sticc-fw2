...
public interface IConstraintInterpretationAS {
	 ...
	 */
	List<? extends Object> evaluateConstraint( 	Object p_constraintExpression,
	 ...
	 * @throws SystemException Should be thrown whenever some system error occurs.
	 */
	List<Boolean> evaluateInvariant( 	Object p_constraintInvariant,
										Map<String, String> p_libraries,
										Object... p_context ) 
	throws ConstraintException, SystemException;
    ...
    void setScopeProviders( Collection<IScopeProvider> p_scopeProviders );
}
