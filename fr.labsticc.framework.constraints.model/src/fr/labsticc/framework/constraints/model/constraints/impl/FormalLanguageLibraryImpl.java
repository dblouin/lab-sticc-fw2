 ...
 * <ul>
 *   <li>{@link fr.labsticc.framework.constraints.model.constraints.impl.FormalLanguageLibraryImpl#getOwnedExpression <em>Owned Expression</em>}</li>
...
public class FormalLanguageLibraryImpl extends IdentifiedElementImpl implements FormalLanguageLibrary {
	 ...
	 * @ordered
	 */
	protected FormalLanguageExpression ownedExpression;
	 ...
	 * @generated
	 */
	public FormalLanguageExpression getOwnedExpression() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOwnedExpression(FormalLanguageExpression newOwnedExpression, NotificationChain msgs) {
		FormalLanguageExpression oldOwnedExpression = ownedExpression;
		ownedExpression = newOwnedExpression;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ConstraintsPackage.FORMAL_LANGUAGE_LIBRARY__OWNED_EXPRESSION, oldOwnedExpression, newOwnedExpression);
	 ...
	 * @generated
	 */
	public void setOwnedExpression(FormalLanguageExpression newOwnedExpression) {
		if (newOwnedExpression != ownedExpression) {
			NotificationChain msgs = null;
			if (ownedExpression != null)
				msgs = ((InternalEObject)ownedExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ConstraintsPackage.FORMAL_LANGUAGE_LIBRARY__OWNED_EXPRESSION, null, msgs);
			if (newOwnedExpression != null)
				msgs = ((InternalEObject)newOwnedExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ConstraintsPackage.FORMAL_LANGUAGE_LIBRARY__OWNED_EXPRESSION, null, msgs);
			msgs = basicSetOwnedExpression(newOwnedExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConstraintsPackage.FORMAL_LANGUAGE_LIBRARY__OWNED_EXPRESSION, newOwnedExpression, newOwnedExpression));
	}
	...
	public FormalConstraintLanguage getLanguage() {
		...
		return (FormalConstraintLanguage)eInternalContainer();
	}
	...
	public void setLanguage(FormalConstraintLanguage newLanguage) {
		if (newLanguage != eInternalContainer() || (eContainerFeatureID() != ConstraintsPackage.FORMAL_LANGUAGE_LIBRARY__LANGUAGE && newLanguage != null)) {
			...
			if (newLanguage != null)
				msgs = ((InternalEObject)newLanguage).eInverseAdd(this, ConstraintsPackage.FORMAL_CONSTRAINT_LANGUAGE__OWNED_LIBRARIES, FormalConstraintLanguage.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConstraintsPackage.FORMAL_LANGUAGE_LIBRARY__OWNED_EXPRESSION:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ConstraintsPackage.FORMAL_LANGUAGE_LIBRARY__LANGUAGE:
				return eInternalContainer().eInverseRemove(this, ConstraintsPackage.FORMAL_CONSTRAINT_LANGUAGE__OWNED_LIBRARIES, FormalConstraintLanguage.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ConstraintsPackage.FORMAL_LANGUAGE_LIBRARY__OWNED_EXPRESSION:
				setOwnedExpression((FormalLanguageExpression)newValue);
				return;
			case ConstraintsPackage.FORMAL_LANGUAGE_LIBRARY__DEFAULT:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ConstraintsPackage.FORMAL_LANGUAGE_LIBRARY__OWNED_EXPRESSION:
				setOwnedExpression((FormalLanguageExpression)null);
				return;
			case ConstraintsPackage.FORMAL_LANGUAGE_LIBRARY__DEFAULT:
