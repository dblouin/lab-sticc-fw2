...
public abstract class ConstraintLanguageImpl extends IdentifiedElementImpl implements ConstraintLanguage {
	...
	public ConstraintLanguagesSpec getSpecification() {
		...
		return (ConstraintLanguagesSpec)eInternalContainer();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSpecification(ConstraintLanguagesSpec newSpecification, NotificationChain msgs) {
	 ...
	 * @generated
	 */
	public void setSpecification(ConstraintLanguagesSpec newSpecification) {
		if (newSpecification != eInternalContainer() || (eContainerFeatureID() != ConstraintsPackage.CONSTRAINT_LANGUAGE__SPECIFICATION && newSpecification != null)) {
			...
			if (newSpecification != null)
				msgs = ((InternalEObject)newSpecification).eInverseAdd(this, ConstraintsPackage.CONSTRAINT_LANGUAGES_SPEC__OWNED_LANGUAGES, ConstraintLanguagesSpec.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConstraintsPackage.CONSTRAINT_LANGUAGE__SPECIFICATION:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetSpecification((ConstraintLanguagesSpec)otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ConstraintsPackage.CONSTRAINT_LANGUAGE__SPECIFICATION:
				return eInternalContainer().eInverseRemove(this, ConstraintsPackage.CONSTRAINT_LANGUAGES_SPEC__OWNED_LANGUAGES, ConstraintLanguagesSpec.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ConstraintsPackage.CONSTRAINT_LANGUAGE__SPECIFICATION:
				setSpecification((ConstraintLanguagesSpec)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ConstraintsPackage.CONSTRAINT_LANGUAGE__SPECIFICATION:
				setSpecification((ConstraintLanguagesSpec)null);
				return;
		}
