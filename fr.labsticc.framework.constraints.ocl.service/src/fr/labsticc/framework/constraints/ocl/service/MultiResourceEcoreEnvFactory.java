...
import fr.labsticc.framework.constraints.service.IScopeProvider;
...
public class MultiResourceEcoreEnvFactory extends EcoreEnvironmentFactory {
	...
	private final Collection<IScopeProvider> scopeProviders;

	/**
	 * Initializes me. Environments that I create will use the global package registry to look up packages.
	 */
	public MultiResourceEcoreEnvFactory( final Collection<IScopeProvider> p_scopeProviders ) {
	...
	public MultiResourceEcoreEnvFactory( 	final EPackage.Registry p_registry,
											final Collection<IScopeProvider> p_scopeProviders ) {
		super( p_registry );
